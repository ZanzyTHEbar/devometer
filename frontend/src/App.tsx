...
import { analyze, type AnalysisResult, isRateLimitError } from "./api";
            ...
            <div class="space-y-3">
              ...
              <div class="flex items-start space-x-3 p-3 bg-slate-50 rounded-lg border border-slate-200">
                <input
                  ...
                  onChange={(e) => setIncludeInLeaderboard((e.target as HTMLInputElement).checked)}
                  class="checkbox checkbox-primary mt-0.5"
                />
                <div class="flex-1">
                  <label for="leaderboard-consent" class="text-sm font-medium text-slate-700 cursor-pointer">
                    Include in Public Leaderboard 🏆
                  </label>
                  <p class="text-xs text-slate-500 mt-1">
                    Opt-in to have your anonymized analysis appear on the public leaderboard.
                    You can change this setting anytime.
                    <a href="/privacy-policy" target="_blank" class="text-primary hover:underline ml-1">
                      Learn more →
                    </a>
                  </p>
                </div>
              ...
              >
                {analysisResult.loading ? (
                  ...
                  <span class="flex items-center justify-center gap-2">🔍 Analyze Crackedness</span>
                )}
              </button>
            </div>
          </div>
                    ...
                    <div class="text-center mb-8">
                      <div class="inline-flex items-center gap-4 mb-4">
                        ...
                        <div class={`px-4 py-2 rounded-full ${gaugeInfo.bgColor}`}>
                          <span class={`font-semibold ${gaugeInfo.color}`}>{gaugeInfo.label}</span>
                        </div>
                      </div>
                    ...
                    <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6">
                      ...
                      <div class="space-y-4">
                        <div class="p-4 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg">
                          <h4 class="font-semibold text-indigo-800 mb-2">🎯 Overall Assessment</h4>
