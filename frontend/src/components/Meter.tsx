  ...
  return (
    ...
    >
      ...
      <g transform="translate(100,100)">
        ...
        {/* Center hub */}
        <circle cx="0" cy="0" r="8" fill="#f8fafc" stroke="#374151" stroke-width="2" />
        ...
        {/* Score display */}
        <text x="0" y="32" text-anchor="middle" font-size="16" fill="#1f2937" font-weight="bold">
